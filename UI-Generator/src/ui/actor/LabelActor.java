...
public class LabelActor extends GameActor implements AbstractUIActor{

    public static final Color BORDER_SELECTED = Color.green;
    public static final Color BORDER_TAKEN = Color.red;
    public static final Color BORDER_DEFAULT = null;
    ...
    public LabelActor(AbstractUIElement parent){
        super();
        this.parent = parent;
        reset();
    }
